...
var sid = ""
var hooks_ctx *HandlerReq
var hook_update_url = ""
var hooks_update = ""
var hooks_update_old = ""

func hooks_start(ctx *HandlerReq) {
	hooks_lock.Lock()
	tmp := rand.Int63()
	...
	hooks_update = filepath.Join(ctx.Dir, "/hooks/update")
	hooks_update_old = filepath.Join(ctx.Dir, "/hooks/update."+sid)
